...
var wasmImports = {
    Ni: _PokiSdkJs_AddParameterForURL,
    Mi: _PokiSdkJs_CaptureError,
    Li: _PokiSdkJs_CommercialBreak,
    Ki: _PokiSdkJs_GameplayStart,
    Ji: _PokiSdkJs_GameplayStop,
    Ii: _PokiSdkJs_GetURLParam,
    Hi: _PokiSdkJs_InternalCaptureError,
    Gi: _PokiSdkJs_IsAdBlocked,
    Fi: _PokiSdkJs_RewardedBreak,
    Ei: _PokiSdkJs_SetDebug,
    Di: _PokiSdkJs_ShareableURL,
    b: ___assert_fail,
    Ci: ___syscall__newselect,
    Bi: ___syscall_accept4,
    Ai: ___syscall_bind,
    zi: ___syscall_connect,
    yi: ___syscall_dup3,
    g: ___syscall_fcntl64,
    xi: ___syscall_getpeername,
    wi: ___syscall_getsockname,
    _: ___syscall_getsockopt,
    vi: ___syscall_ioctl,
    ui: ___syscall_listen,
    ti: ___syscall_mkdirat,
    Z: ___syscall_openat,
    si: ___syscall_poll,
    ri: ___syscall_readlinkat,
    qi: ___syscall_recvfrom,
    pi: ___syscall_renameat,
    oi: ___syscall_rmdir,
    ni: ___syscall_sendto,
    mi: ___syscall_shutdown,
    Da: ___syscall_socket,
    li: ___syscall_stat64,
    Y: ___syscall_unlinkat,
    ii: __abort_js,
    hi: __emscripten_lookup_name,
    gi: __emscripten_system,
    fi: __emscripten_throw_longjmp,
    Ja: __gmtime_js,
    Ia: __localtime_js,
    Ha: __mktime_js,
    ei: __tzset_js,
    La: _clock_time_get,
    di: _dmDeviceJSFreeBufferSlots,
    ci: _dmDeviceJSOpen,
    bi: _dmDeviceJSQueue,
    Ba: _dmGetDeviceSampleRate,
    ai: _dmResZipRequestFileAsync,
    $h: _dmScriptHttpRequestAsync,
    _h: _dmSysGetApplicationPath,
    Zh: _dmSysGetUserAgent,
    Yh: _dmSysGetUserPersistentDataRoot,
    Xh: _dmSysGetUserPreferredLanguage,
    Wh: _dmSysOpenURL,
    z: _emscripten_asm_const_int,
    Vh: _emscripten_cancel_main_loop,
    Aa: _emscripten_date_now,
    Uh: _emscripten_get_heap_max,
    za: _emscripten_get_now,
    Th: _emscripten_glActiveTexture,
    Sh: _emscripten_glAttachShader,
    Rh: _emscripten_glBeginQuery,
    Qh: _emscripten_glBeginQueryEXT,
    Ph: _emscripten_glBeginTransformFeedback,
    Oh: _emscripten_glBindAttribLocation,
    Nh: _emscripten_glBindBuffer,
    Mh: _emscripten_glBindBufferBase,
    Lh: _emscripten_glBindBufferRange,
    Kh: _emscripten_glBindFramebuffer,
    Jh: _emscripten_glBindRenderbuffer,
    Ih: _emscripten_glBindSampler,
    Hh: _emscripten_glBindTexture,
    Gh: _emscripten_glBindTransformFeedback,
    Fh: _emscripten_glBindVertexArray,
    Eh: _emscripten_glBindVertexArrayOES,
    ...
    yh: _emscripten_glBlitFramebuffer,
    xh: _emscripten_glBufferData,
    wh: _emscripten_glBufferSubData,
    vh: _emscripten_glCheckFramebufferStatus,
    uh: _emscripten_glClear,
    th: _emscripten_glClearBufferfi,
    sh: _emscripten_glClearBufferfv,
    rh: _emscripten_glClearBufferiv,
    qh: _emscripten_glClearBufferuiv,
    ph: _emscripten_glClearColor,
    oh: _emscripten_glClearDepthf,
    nh: _emscripten_glClearStencil,
    mh: _emscripten_glClientWaitSync,
    lh: _emscripten_glClipControlEXT,
    kh: _emscripten_glColorMask,
    jh: _emscripten_glCompileShader,
    ih: _emscripten_glCompressedTexImage2D,
    hh: _emscripten_glCompressedTexImage3D,
    gh: _emscripten_glCompressedTexSubImage2D,
    fh: _emscripten_glCompressedTexSubImage3D,
    eh: _emscripten_glCopyBufferSubData,
    dh: _emscripten_glCopyTexImage2D,
    ch: _emscripten_glCopyTexSubImage2D,
    bh: _emscripten_glCopyTexSubImage3D,
    ah: _emscripten_glCreateProgram,
    $g: _emscripten_glCreateShader,
    _g: _emscripten_glCullFace,
    Zg: _emscripten_glDeleteBuffers,
    Yg: _emscripten_glDeleteFramebuffers,
    Xg: _emscripten_glDeleteProgram,
    Wg: _emscripten_glDeleteQueries,
    Vg: _emscripten_glDeleteQueriesEXT,
    Ug: _emscripten_glDeleteRenderbuffers,
    Tg: _emscripten_glDeleteSamplers,
    Sg: _emscripten_glDeleteShader,
    Rg: _emscripten_glDeleteSync,
    Qg: _emscripten_glDeleteTextures,
    Pg: _emscripten_glDeleteTransformFeedbacks,
    Og: _emscripten_glDeleteVertexArrays,
    Ng: _emscripten_glDeleteVertexArraysOES,
    Mg: _emscripten_glDepthFunc,
    Lg: _emscripten_glDepthMask,
    Kg: _emscripten_glDepthRangef,
    Jg: _emscripten_glDetachShader,
    Ig: _emscripten_glDisable,
    Hg: _emscripten_glDisableVertexAttribArray,
    Gg: _emscripten_glDrawArrays,
    Fg: _emscripten_glDrawArraysInstanced,
    Eg: _emscripten_glDrawArraysInstancedANGLE,
    Dg: _emscripten_glDrawArraysInstancedARB,
    Cg: _emscripten_glDrawArraysInstancedEXT,
    Bg: _emscripten_glDrawArraysInstancedNV,
    Ag: _emscripten_glDrawBuffers,
    zg: _emscripten_glDrawBuffersEXT,
    yg: _emscripten_glDrawBuffersWEBGL,
    xg: _emscripten_glDrawElements,
    wg: _emscripten_glDrawElementsInstanced,
    vg: _emscripten_glDrawElementsInstancedANGLE,
    ug: _emscripten_glDrawElementsInstancedARB,
    tg: _emscripten_glDrawElementsInstancedEXT,
    sg: _emscripten_glDrawElementsInstancedNV,
    rg: _emscripten_glDrawRangeElements,
    qg: _emscripten_glEnable,
    pg: _emscripten_glEnableVertexAttribArray,
    og: _emscripten_glEndQuery,
    ng: _emscripten_glEndQueryEXT,
    mg: _emscripten_glEndTransformFeedback,
    lg: _emscripten_glFenceSync,
    ...
    gg: _emscripten_glFramebufferTextureLayer,
    fg: _emscripten_glFrontFace,
    eg: _emscripten_glGenBuffers,
    dg: _emscripten_glGenFramebuffers,
    cg: _emscripten_glGenQueries,
    bg: _emscripten_glGenQueriesEXT,
    ag: _emscripten_glGenRenderbuffers,
    $f: _emscripten_glGenSamplers,
    _f: _emscripten_glGenTextures,
    Zf: _emscripten_glGenTransformFeedbacks,
    Yf: _emscripten_glGenVertexArrays,
    Xf: _emscripten_glGenVertexArraysOES,
    Wf: _emscripten_glGenerateMipmap,
    Vf: _emscripten_glGetActiveAttrib,
    Uf: _emscripten_glGetActiveUniform,
    Tf: _emscripten_glGetActiveUniformBlockName,
    Sf: _emscripten_glGetActiveUniformBlockiv,
    Rf: _emscripten_glGetActiveUniformsiv,
    Qf: _emscripten_glGetAttachedShaders,
    Pf: _emscripten_glGetAttribLocation,
    Of: _emscripten_glGetBooleanv,
    Nf: _emscripten_glGetBufferParameteri64v,
    Mf: _emscripten_glGetBufferParameteriv,
    Lf: _emscripten_glGetError,
    Kf: _emscripten_glGetFloatv,
    Jf: _emscripten_glGetFragDataLocation,
    If: _emscripten_glGetFramebufferAttachmentParameteriv,
    Hf: _emscripten_glGetInteger64i_v,
    Gf: _emscripten_glGetInteger64v,
    Ff: _emscripten_glGetIntegeri_v,
    Ef: _emscripten_glGetIntegerv,
    Df: _emscripten_glGetInternalformativ,
    Cf: _emscripten_glGetProgramBinary,
    Bf: _emscripten_glGetProgramInfoLog,
    Af: _emscripten_glGetProgramiv,
    zf: _emscripten_glGetQueryObjecti64vEXT,
    yf: _emscripten_glGetQueryObjectivEXT,
    xf: _emscripten_glGetQueryObjectui64vEXT,
    wf: _emscripten_glGetQueryObjectuiv,
    vf: _emscripten_glGetQueryObjectuivEXT,
    uf: _emscripten_glGetQueryiv,
    tf: _emscripten_glGetQueryivEXT,
    sf: _emscripten_glGetRenderbufferParameteriv,
    rf: _emscripten_glGetSamplerParameterfv,
    qf: _emscripten_glGetSamplerParameteriv,
    pf: _emscripten_glGetShaderInfoLog,
    of: _emscripten_glGetShaderPrecisionFormat,
    nf: _emscripten_glGetShaderSource,
    mf: _emscripten_glGetShaderiv,
    lf: _emscripten_glGetString,
    kf: _emscripten_glGetStringi,
    jf: _emscripten_glGetSynciv,
    hf: _emscripten_glGetTexParameterfv,
    gf: _emscripten_glGetTexParameteriv,
    ff: _emscripten_glGetTransformFeedbackVarying,
    ef: _emscripten_glGetUniformBlockIndex,
    df: _emscripten_glGetUniformIndices,
    cf: _emscripten_glGetUniformLocation,
    bf: _emscripten_glGetUniformfv,
    af: _emscripten_glGetUniformiv,
    $e: _emscripten_glGetUniformuiv,
    _e: _emscripten_glGetVertexAttribIiv,
    Ze: _emscripten_glGetVertexAttribIuiv,
    Ye: _emscripten_glGetVertexAttribPointerv,
    Xe: _emscripten_glGetVertexAttribfv,
    We: _emscripten_glGetVertexAttribiv,
    Ve: _emscripten_glHint,
    Ue: _emscripten_glInvalidateFramebuffer,
    Te: _emscripten_glInvalidateSubFramebuffer,
    Se: _emscripten_glIsBuffer,
    Re: _emscripten_glIsEnabled,
    Qe: _emscripten_glIsFramebuffer,
    Pe: _emscripten_glIsProgram,
    Oe: _emscripten_glIsQuery,
    Ne: _emscripten_glIsQueryEXT,
    Me: _emscripten_glIsRenderbuffer,
    Le: _emscripten_glIsSampler,
    Ke: _emscripten_glIsShader,
    Je: _emscripten_glIsSync,
    Ie: _emscripten_glIsTexture,
    He: _emscripten_glIsTransformFeedback,
    Ge: _emscripten_glIsVertexArray,
    Fe: _emscripten_glIsVertexArrayOES,
    Ee: _emscripten_glLineWidth,
    De: _emscripten_glLinkProgram,
    Ce: _emscripten_glPauseTransformFeedback,
    Be: _emscripten_glPixelStorei,
    Ae: _emscripten_glPolygonModeWEBGL,
    ze: _emscripten_glPolygonOffset,
    ye: _emscripten_glPolygonOffsetClampEXT,
    xe: _emscripten_glProgramBinary,
    we: _emscripten_glProgramParameteri,
    ve: _emscripten_glQueryCounterEXT,
    ue: _emscripten_glReadBuffer,
    te: _emscripten_glReadPixels,
    se: _emscripten_glReleaseShaderCompiler,
    re: _emscripten_glRenderbufferStorage,
    qe: _emscripten_glRenderbufferStorageMultisample,
    pe: _emscripten_glResumeTransformFeedback,
    oe: _emscripten_glSampleCoverage,
    ne: _emscripten_glSamplerParameterf,
    me: _emscripten_glSamplerParameterfv,
    le: _emscripten_glSamplerParameteri,
    ke: _emscripten_glSamplerParameteriv,
    ...
    Wd: _emscripten_glTexStorage2D,
    Vd: _emscripten_glTexStorage3D,
    Ud: _emscripten_glTexSubImage2D,
    Td: _emscripten_glTexSubImage3D,
    Sd: _emscripten_glTransformFeedbackVaryings,
    Rd: _emscripten_glUniform1f,
    Qd: _emscripten_glUniform1fv,
    Pd: _emscripten_glUniform1i,
    Od: _emscripten_glUniform1iv,
    Nd: _emscripten_glUniform1ui,
    Md: _emscripten_glUniform1uiv,
    Ld: _emscripten_glUniform2f,
    Kd: _emscripten_glUniform2fv,
    Jd: _emscripten_glUniform2i,
    Id: _emscripten_glUniform2iv,
    Hd: _emscripten_glUniform2ui,
    Gd: _emscripten_glUniform2uiv,
    Fd: _emscripten_glUniform3f,
    Ed: _emscripten_glUniform3fv,
    Dd: _emscripten_glUniform3i,
    Cd: _emscripten_glUniform3iv,
    Bd: _emscripten_glUniform3ui,
    Ad: _emscripten_glUniform3uiv,
    zd: _emscripten_glUniform4f,
    yd: _emscripten_glUniform4fv,
    xd: _emscripten_glUniform4i,
    wd: _emscripten_glUniform4iv,
    vd: _emscripten_glUniform4ui,
    ud: _emscripten_glUniform4uiv,
    td: _emscripten_glUniformBlockBinding,
    sd: _emscripten_glUniformMatrix2fv,
    rd: _emscripten_glUniformMatrix2x3fv,
    qd: _emscripten_glUniformMatrix2x4fv,
    pd: _emscripten_glUniformMatrix3fv,
    od: _emscripten_glUniformMatrix3x2fv,
    nd: _emscripten_glUniformMatrix3x4fv,
    md: _emscripten_glUniformMatrix4fv,
    ld: _emscripten_glUniformMatrix4x2fv,
    kd: _emscripten_glUniformMatrix4x3fv,
    jd: _emscripten_glUseProgram,
    id: _emscripten_glValidateProgram,
    hd: _emscripten_glVertexAttrib1f,
    gd: _emscripten_glVertexAttrib1fv,
    fd: _emscripten_glVertexAttrib2f,
    ed: _emscripten_glVertexAttrib2fv,
    dd: _emscripten_glVertexAttrib3f,
    cd: _emscripten_glVertexAttrib3fv,
    bd: _emscripten_glVertexAttrib4f,
    ad: _emscripten_glVertexAttrib4fv,
    $c: _emscripten_glVertexAttribDivisor,
    _c: _emscripten_glVertexAttribDivisorANGLE,
    Zc: _emscripten_glVertexAttribDivisorARB,
    Yc: _emscripten_glVertexAttribDivisorEXT,
    Xc: _emscripten_glVertexAttribDivisorNV,
    Wc: _emscripten_glVertexAttribI4i,
    Vc: _emscripten_glVertexAttribI4iv,
    Uc: _emscripten_glVertexAttribI4ui,
    Tc: _emscripten_glVertexAttribI4uiv,
    Sc: _emscripten_glVertexAttribIPointer,
    Rc: _emscripten_glVertexAttribPointer,
    Qc: _emscripten_glViewport,
    Pc: _emscripten_glWaitSync,
    Oc: _emscripten_pause_main_loop,
    Nc: _emscripten_resize_heap,
    W: _emscripten_set_main_loop_arg,
    d: _emscripten_webgl_enable_extension,
    Mc: _emscripten_webgl_get_current_context,
    ki: _environ_get,
    ji: _environ_sizes_get,
    V: _exit,
    A: _fd_close,
    Ca: _fd_read,
    Ka: _fd_seek,
    ...
    U: _glAttachShader,
    e: _glBindBuffer,
    xa: _glBindBufferBase,
    T: _glBindFramebuffer,
    s: _glBindRenderbuffer,
    m: _glBindTexture,
    Lc: _glBindVertexArray,
    Kc: _glBlendFunc,
    J: _glBufferData,
    wa: _glBufferSubData,
    ...
    va: _glCompressedTexSubImage3D,
    ua: _glCreateProgram,
    ta: _glCreateShader,
    Ec: _glCullFace,
    sa: _glDeleteBuffers,
    Dc: _glDeleteFramebuffers,
    Q: _glDeleteProgram,
    Cc: _glDeleteRenderbuffers,
    P: _glDeleteShader,
    ra: _glDeleteTextures,
    Bc: _glDepthFunc,
    Ac: _glDepthMask,
    zc: _glDisable,
    yc: _glDisableVertexAttribArray,
    xc: _glDrawArrays,
    wc: _glDrawArraysInstanced,
    vc: _glDrawBuffers,
    uc: _glDrawElements,
    tc: _glDrawElementsInstanced,
    sc: _glEnable,
    rc: _glEnableVertexAttribArray,
    qc: _glFlush,
    pc: _glFramebufferRenderbuffer,
    oc: _glFramebufferTexture2D,
    nc: _glFrontFace,
    O: _glGenBuffers,
    mc: _glGenFramebuffers,
    y: _glGenRenderbuffers,
    qa: _glGenTextures,
    lc: _glGenVertexArrays,
    kc: _glGetActiveAttrib,
    jc: _glGetActiveUniform,
    ...
    Ub: _glUniformMatrix4fv,
    ja: _glUseProgram,
    Tb: _glVertexAttribDivisor,
    Sb: _glVertexAttribPointer,
    Rb: _glViewport,
    Qb: _glfwAccelerometerEnable,
    Pb: _glfwCloseWindow,
    Ob: _glfwDisable,
    Nb: _glfwEnable,
    Mb: _glfwGetAcceleration,
    ia: _glfwGetDefaultFramebuffer,
    ha: _glfwGetDisplayScaleFactor,
    Lb: _glfwGetJoystickButtons,
    Kb: _glfwGetJoystickDeviceId,
    Jb: _glfwGetJoystickHats,
    D: _glfwGetJoystickParam,
    Ib: _glfwGetJoystickPos,
    Hb: _glfwGetKey,
    h: _glfwGetMouseButton,
    Gb: _glfwGetMouseLocked,
    Fb: _glfwGetMousePos,
    Eb: _glfwGetMouseWheel,
    Db: _glfwGetWindowParam,
    Cb: _glfwGetWindowRefreshRate,
    ga: _glfwGetWindowSize,
    Bb: _glfwIconifyWindow,
    Ab: _glfwInitJS,
    fa: _glfwOpenWindow,
    w: _glfwOpenWindowHint,
    zb: _glfwPollEvents,
    yb: _glfwResetKeyboard,
    xb: _glfwSetCharCallback,
    wb: _glfwSetDeviceChangedCallback,
    vb: _glfwSetGamepadCallback,
    ub: _glfwSetMarkedTextCallback,
    tb: _glfwSetTouchCallback,
    sb: _glfwSetWindowBackgroundColor,
    rb: _glfwSetWindowCloseCallback,
    qb: _glfwSetWindowFocusCallback,
    pb: _glfwSetWindowIconifyCallback,
    ob: _glfwSetWindowPos,
    nb: _glfwSetWindowSize,
    ...
    K: _js_initialize,
    Ra: _js_isRemoteConfigsReady,
    Qa: _js_setCustomDimension01,
    Pa: _js_setCustomDimension02,
    Oa: _js_setCustomDimension03,
    ca: _js_setEnabledInfoLog,
    ba: _js_setEnabledVerboseLog,
    aa: _js_setEventSubmission,
    Na: _js_setGlobalCustomEventFields,
    $: _js_setManualSessionHandling,
    Ma: _js_startSession,
    a: wasmMemory,
    Ea: _setupCallbackJS
};
...
var _js_remote_configs_callback = Module["_js_remote_configs_callback"] = function () {
    return (_js_remote_configs_callback = Module["_js_remote_configs_callback"] = wasmExports["Ui"])()
};
